...
parser.add_argument('-totiters_for_model', dest='totiters_for_model', action='store', help='totiters_for_model', type=int, default=25)
...
extrastr = '_databl_seed%s_mass%.3f_z%.3f' %(random_seed_for_models, keyname[0], keyname[1])
