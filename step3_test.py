...
random_stack = random_stack_dic.squeeze()#[0]
...
if (1):
    ...
    # cluster_cutouts_rotated_arr=data['clusters']['cutouts_rotated'] - random_stack #[dummysimcntr]
    # print(cluster_cutouts_rotated_arr.shape)
    # cluster_grad_mag_arr=data['clusters']['grad_mag']#[dummysimcntr]
    # print(cluster_grad_mag_arr.shape)
...
if (0):
    data=np.load('./data.npy',allow_pickle=True).item()
    #print(data.keys())
    data_stack_dic = np.load('./data_stack_dic.npy',allow_pickle=True)#.item()#data['clusters']['stack']
    model_dic=np.load('./model_dic.npy',allow_pickle=True).item()
    #print(model_dic.keys())
    jk_cov=np.load('./jk_cov.npy',allow_pickle=True)#.item()
    #print(jk_cov.shape)
    imshow(data_stack_dic[0][10:30,10:30],cmap=cmap);colorbar();show()    #,vmin=-3.0,vmax=3.0
    imshow(data_stack_dic[1][10:30,10:30],cmap=cmap);colorbar();show()
    imshow(data_stack_dic[2][10:30,10:30],cmap=cmap);colorbar();show()
    imshow(model_dic[(2.3,0.5)][0][10:30,10:30],cmap=cmap);colorbar();show()
    imshow(model_dic[(2.3,0.5)][1][10:30,10:30],cmap=cmap);colorbar();show()
    imshow(model_dic[(2.3,0.5)][2][10:30,10:30],cmap=cmap);colorbar();show()
