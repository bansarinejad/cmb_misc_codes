...
#     nl_twod_dic_BB = nl_oned_dic_BB
    ...
    if full_sky:
        ...
        #np.save('./T_95_150_220_winterfield_fullsky_ILC_v3.npy', ilc_map_T)
        ...
        np.save('./Q_95_150_220_winterfield_fullsky_ILC_v2.npy', ilc_map_Q)
        ...
        np.save('./U_95_150_220_winterfield_fullsky_ILC_v2.npy', ilc_map_U)
    end_time7 = time.time()
    ...
    ilc_map_T=np.load('./T_95_150_220_winterfield_fullsky_ILC_v3.npy',allow_pickle=True)
