...
import flatsky, tools, tools_data, tools_data_backup, lensing, foregrounds, misc
...
m_temp=[None]*10
for i in range(10):
  t_temp[i] = np.load('./merged_rand_parts_nw/ILC_cutouts_U_rands_nw_part%s.npy' %(i), allow_pickle= True)
...
np.save('./stacks/randoms_m200cut_U_ILC_healpix_nw_apod_zeros_masked_inpaint_v3.npy', sim_dic)
